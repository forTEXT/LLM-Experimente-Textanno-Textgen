# -*- coding: utf-8 -*-
"""
Original Code see: https://github.com/forTEXT/catma-py/blob/master/catma_py/catma.py
...
# collection = "pathoto/heureclea-time-annotations-compared-public-076c83a/Auch ich war in Arkadien dates Annotator1.xml"
# source_text = "pathto/heureclea-sourcedocuments-4aceaf9/Auch_ich_war_in_Arkadien.txt"

# convert_ptr_refs_to_text(collection, source_text, "./LLMs/Heurecla/heureclea/annostotxt/annostotext_auchichwar.xml")


# # Erstellen einer Instanz des TEIAnnotationReader
# reader = TEIAnnotationReader(filename='pathto/heureclea-time-annotations-compared-public-076c83a/Auch ich war in Arkadien dates Annotator1.xml')
...
#     annotationsid = annotation.uuid  # UUID der Annotation
